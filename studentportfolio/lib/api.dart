...
List data = [];
List images = [
  {'img': 'assets/freepik.png'},
  {'img': 'assets/user.jpg'},
  {'img': 'assets/HARI HARA SUDHAN-22IT14.jpg'},
  {'img': 'assets/freepik.png'},
  {'img': 'assets/freepik.png'},
  {'img': 'assets/freepik.png'},
  {'img': 'assets/freepik.png'},
  ...
  Future<void> fetchData() async {
    final response =
        ...
        await http.get(Uri.parse(
            'https://madhankumar22it27.github.io/json-data-repo/data.json')); // priyabharathi copy
      ...
      body: ListView.builder(
        ...
        itemBuilder: (context, index) {
          return LandingPageProfile(
              ...
              filteredData[index]['mobileno'].toString(),
              filteredData[index]['blood_group'].toString(),
              filteredData[index]['degree'].toString(),
